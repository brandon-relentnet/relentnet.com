...
export const storeFeatures = [
  {
    ...
    description:
      "Smart cart with saved items, wishlists, and lightning-fast checkout process.",
  },
  {
    icon: "CreditCardIcon",
    title: "Secure Payments",
    description:
      "Accept all major payment methods with bank-level security and fraud protection.",
  },
  {
    icon: "TruckIcon",
    title: "Shipping Made Easy",
    description:
      "Real-time shipping rates, order tracking, and automated carrier integration.",
  },
  {
    icon: "ChartBarIcon",
    title: "Sales Analytics",
    description:
      "Track performance, monitor inventory, and understand customer behavior.",
  },
  {
    icon: "DevicePhoneMobileIcon",
    title: "Mobile-First Design",
    description:
      "Beautiful, responsive design that works perfectly on every device.",
  },
  {
...
export const storeTestimonials = [
  {
    ...
    quote:
      "Sales increased 300% in just 3 months. The platform is incredibly easy to use and my customers love the smooth checkout process.",
  },
  {
    name: "Mike Chen",
    business: "Electronics Retailer",
    quote:
      "The inventory management features saved us countless hours. We can now focus on growing our business instead of managing technical details.",
  },
  {
    name: "Emily Rodriguez",
    business: "Handmade Crafts",
    quote:
      "I went from zero online presence to $50K in monthly sales. The support team helped me every step of the way.",
  },
];
...
export const storeFaqs = [
  {
    ...
    answer:
      "Most stores are live within 24-48 hours! We'll handle the technical setup while you focus on adding your products and customizing your store's look.",
  },
  {
    question: "Do I need technical skills to manage my store?",
    answer:
      "Not at all! Our platform is designed for business owners, not developers. Adding products, processing orders, and managing inventory is as simple as using social media.",
  },
  {
    question: "What payment methods can I accept?",
    answer:
      "We support all major credit cards, PayPal, Apple Pay, Google Pay, and many regional payment options. Your customers can pay however they prefer.",
  },
  {
    question: "How much do transaction fees cost?",
    answer:
      "Our Starter plan has a 2% transaction fee, Professional has 1%, and Enterprise customers pay no transaction fees. All plans include secure payment processing.",
  },
  {
    question: "Can I customize the design of my store?",
    answer:
      "Absolutely! Choose from dozens of professional themes, or we can create a completely custom design that matches your brand perfectly.",
  },
  {
    question: "What if I need help with my store?",
    answer:
      "Our support team is here to help! Starter customers get email support, Professional customers get priority phone support, and Enterprise customers have a dedicated account manager.",
  },
];
...
export const builderTemplates = [
  {
    ...
    description:
      "Professional template perfect for service-based businesses and consultants.",
  },
  {
    ...
    description:
      "Conversion-optimized template designed for online retailers and product sellers.",
  },
  {
    ...
    description:
      "Stunning portfolio template for artists, designers, and creative professionals.",
  },
  {
    ...
    description:
      "Mouth-watering template perfect for restaurants and food businesses.",
  },
  {
    name: "Fitness Focus",
    ...
    description:
      "Energetic template designed for gyms, trainers, and wellness businesses.",
  },
  {
    name: "Tech Startup",
    category: "Technology",
    ...
    description:
      "Modern template perfect for tech companies and SaaS businesses.",
  },
];
...
export const builderFaqs = [
  {
    ...
    answer:
      "Not at all! Our membership gives you access to Divi and Elementor, the most user-friendly drag-and-drop builders. Plus, we provide video tutorials to guide you through everything.",
  },
  {
    question: "Can I use these templates for client projects?",
    answer:
      "Yes! Professional and Agency plans include commercial licenses. You can use our templates for unlimited client projects and even white-label them as your own.",
  },
  {
    question: "How often do you add new templates?",
    answer:
      "We add 5-10 new templates every month across different industries. Members get instant access to all new releases as part of their subscription.",
  },
  {
    question: "What's included in the video tutorials?",
    answer:
      "Our tutorial library covers everything from basic Divi/Elementor usage to advanced techniques like custom animations, responsive design, and conversion optimization.",
  },
  {
    question: "Can I cancel my membership anytime?",
    answer:
      "Absolutely! You can cancel your membership at any time. You'll continue to have access until the end of your current billing period.",
  },
  {
    question: "Do you provide support if I get stuck?",
    answer:
      "Yes! All plans include email support. Professional and Agency members get priority support and access to live Q&A sessions with our experts.",
  },
];
...
export const wordpressFeatures = [
  {
    ...
    description:
      "WordPress-optimized servers with advanced caching deliver sub-2-second load times.",
  },
  {
    icon: "ShieldCheckIcon",
    title: "Advanced WordPress Security",
    description:
      "Malware scanning, firewall protection, and automatic security updates keep your site safe.",
  },
  {
    icon: "WrenchIcon",
    title: "One-Click WordPress Tools",
    description:
      "Easy installation, automatic updates, and staging environments for seamless development.",
  },
  {
    icon: "ClockIcon",
    title: "Automated Daily Backups",
    description:
      "Your content is automatically backed up daily with easy one-click restoration.",
  },
  {
    icon: "ChartBarIcon",
    title: "Performance Analytics",
    description:
      "Real-time monitoring with detailed reports on speed, uptime, and optimization opportunities.",
  },
  {
    icon: "ServerIcon",
    title: "99.9% Uptime SLA",
    description:
      "Enterprise-grade infrastructure with redundant systems and guaranteed uptime.",
  },
];
...
export const wordpressTestimonials = [
  {
    ...
    business: "Tech Blog",
    quote:
      "My WordPress site went from 6-second load times to under 2 seconds. The performance difference is incredible and my readers love it.",
  },
  {
    name: "Sarah Williams",
    business: "Digital Agency",
    quote:
      "We host 50+ client sites here. The staging environments and one-click tools make our development workflow seamless.",
  },
  {
    name: "David Rodriguez",
    business: "E-commerce Store",
    quote:
      "Since switching, we've had zero downtime issues. The automatic backups saved us when we had a plugin conflict.",
  },
];
...
export const wordpressFaqs = [
  {
    ...
    answer:
      "This is specialized WordPress hosting. Our servers are optimized specifically for WordPress with custom caching, security, and performance features you won't find on regular hosting.",
  },
  {
    question: "Can I migrate my existing WordPress site?",
    answer:
      "Absolutely! We provide free migration for all plans. Our team will handle the technical details and ensure zero downtime during the transfer.",
  },
  {
    question: "What makes this faster than other WordPress hosts?",
    answer:
      "We use WordPress-specific caching, optimized server configurations, SSD storage, and a content delivery network (CDN) to deliver lightning-fast performance.",
  },
  {
    question: "Do you handle WordPress updates and maintenance?",
    answer:
      "Yes! We automatically update WordPress core, themes, and plugins (with rollback protection). You can focus on content while we handle the technical maintenance.",
  },
  {
    question: "What if my site gets hacked or infected?",
    answer:
      "Our security suite includes malware scanning, automatic removal, and restoration from clean backups. Plus, we provide free cleanup if anything gets through.",
  },
  {
    question: "Can I install custom themes and plugins?",
    answer:
      "Of course! You have full control over your WordPress installation. Install any themes, plugins, or customizations you need.",
  },
];
...
export const webHostingFeatures = [
  {
    ...
    description:
      "Your personal hosting expert handles everything so you can focus on growing your business.",
  },
  {
    icon: "PhoneIcon",
    title: "Premium Support Hours",
    description:
      "Get direct phone support with our experts when you need help most.",
  },
  {
    icon: "CloudIcon",
    title: "Fully Managed Platform",
    description:
      "We handle servers, updates, security, and optimization - you run your business.",
  },
  {
    icon: "ShieldCheckIcon",
    title: "Enterprise Security Suite",
    description:
      "Advanced firewall, SSL certificates, and 24/7 security monitoring included.",
  },
  {
    icon: "RocketLaunchIcon",
    title: "Performance Optimization",
    description:
      "Our team continuously optimizes your site for maximum speed and reliability.",
  },
  {
    icon: "WrenchIcon",
    title: "White-Glove Setup",
    description:
      "We set up everything for you - hosting, email, domains, and any integrations you need.",
  },
];
...
export const webHostingTestimonials = [
  {
    ...
    business: "Law Firm",
    quote:
      "Having someone else handle all the technical stuff is priceless. We can focus on our clients while RelentNet keeps our website running perfectly.",
  },
  {
    name: "Michael Torres",
    business: "Manufacturing Company",
    quote:
      "The monthly phone support is a game-changer. Whenever we need changes or have questions, we just call and they take care of everything.",
  },
  {
    name: "Lisa Park",
    business: "Marketing Agency",
    quote:
      "We manage 20+ client websites on their platform. The white-glove service and dedicated account manager make our lives so much easier.",
  },
];
...
export const webHostingFaqs = [
  {
    ...
    answer:
      "We handle everything: server maintenance, security updates, performance optimization, backups, and monitoring. You just focus on your business while we keep your website running perfectly.",
  },
  {
    question: "How does the monthly phone support work?",
    answer:
      "Professional plan gets 2 hours, Enterprise gets 4 hours of direct phone time with our experts each month. Use it for consultations, technical help, or website changes - whatever you need.",
  },
  {
    question: "Can you help with website changes and updates?",
    answer:
      "Absolutely! That's what your support hours are for. Content updates, design changes, new features - our team can handle it all within your monthly allocation.",
  },
  {
    question: "What if I need more than my monthly support hours?",
    answer:
      "No problem! Additional support time is available at $75/hour for Professional plans and $60/hour for Enterprise plans. Or you can upgrade to the next tier.",
  },
  {
    question: "Do you work with existing websites or only new builds?",
    answer:
      "We work with both! We can migrate your existing website to our platform, or we can build you a brand new one. Migration and setup are included in all plans.",
  },
  {
    question: "What happens if my website goes down?",
    answer:
      "Our 24/7 monitoring system alerts us immediately, and we start fixing issues before you even notice. Plus, all plans include a 99.9% uptime guarantee.",
  },
];
...
export const vpsFeatures = [
  {
    ...
    description:
      "Guaranteed CPU cores, RAM, and storage that nobody else can touch.",
  },
  {
    icon: "CommandLineIcon",
    title: "Full Root Access",
    description:
      "Complete control with root/administrator access to configure everything exactly how you want.",
  },
  {
    icon: "CubeIcon",
    title: "Instant Scaling",
    description:
      "Upgrade CPU, RAM, or storage in seconds without downtime or data migration.",
  },
  {
    icon: "ShieldCheckIcon",
    title: "Enterprise Security",
    description:
      "DDoS protection, firewall management, and optional security hardening services.",
  },
  {
    icon: "ClockIcon",
    title: "99.9% Uptime SLA",
  ...
  },
  {
    ...
    description:
      "Choose self-managed for full control or managed services for peace of mind.",
  },
];
...
export const vpsPlans = [
  ...
  },
  {
    ...
    bandwidth: "16 TB",
    description:
      "Enterprise-grade performance for mission-critical applications",
    features: [
    ...
    bestFor:
      "Enterprise applications, high-availability systems, large databases",
  },
];
...
export const vpsTestimonials = [
  {
    ...
    quote:
      "The ability to scale resources instantly saved our app during a traffic spike. We went from 2GB to 8GB RAM in under 30 seconds.",
  },
  {
    name: "Rachel Kim",
    business: "Development Agency",
    quote:
      "Having full root access means we can configure the server exactly how we need it for each client project. The performance is outstanding.",
  },
  {
    name: "James Wilson",
    business: "E-commerce Platform",
    quote:
      "We've been running our high-traffic store on their VPS for 2 years. Zero downtime, amazing support, and the scaling flexibility is perfect.",
  },
];
...
export const vpsFaqs = [
  {
    ...
    answer:
      "VPS gives you dedicated resources (CPU, RAM, storage) that are guaranteed and isolated. Shared hosting means you're competing with other sites for the same resources, which can slow you down.",
  },
  {
    question: "Do I need technical knowledge to manage a VPS?",
    answer:
      "For self-managed VPS, yes - you'll need to handle server administration. But we offer managed VPS options where our team handles all the technical aspects for you.",
  },
  {
    question: "Can I upgrade my VPS resources later?",
    answer:
      "Absolutely! You can upgrade CPU, RAM, or storage instantly without downtime. Downgrades require a support ticket but are also possible.",
  },
  {
    question: "What operating systems can I install?",
    answer:
      "We support all major Linux distributions (Ubuntu, CentOS, Debian, etc.) and Windows Server. You can also upload custom ISO images if needed.",
  },
  {
    question: "How is VPS different from dedicated servers?",
    answer:
      "VPS runs on shared physical hardware but gives you dedicated virtual resources. Dedicated servers give you an entire physical machine. VPS is more cost-effective for most use cases.",
  },
  {
    question: "What kind of support do you provide?",
    answer:
      "All VPS plans include technical support for the hosting infrastructure. Managed VPS plans include support for the operating system and applications too.",
  },
];
