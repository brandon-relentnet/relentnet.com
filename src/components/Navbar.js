...
export default function Navbar() {
  return (
    <>
      <NavbarClient>
        <div className="navbar fixed top-0 left-0 right-0 h-18 z-200 bg-base-100 shadow-sm text-base-content">
              ...
              <li key={index}>
                {item.dropdown ? (
                  <details data-dropdown-id={`nav-${index}`}>
                    <summary data-dropdown-id={`nav-${index}`}>{item.label}</summary>
                    <ul className="dropdown-content bg-base-100 rounded-box z-1 !mt-6 w-80 p-2 shadow">
                      {item.sections.map((section, sectionIndex) => (
                        <div key={sectionIndex}>
                          <li className="menu-title text-primary">
                            {section.sectionLabel}
        ...
        <div className="navbar-end">
          <div className="dropdown dropdown-end">
            <details data-dropdown-id="account">
              ...
              <ul className="menu dropdown-content bg-base-100 rounded-box z-1 mt-4 w-72 p-2 shadow">
