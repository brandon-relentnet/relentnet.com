...
const ServicesSection = () => {
  return (
    <section id="our-services" className="relative py-[6vh] scroll-m-20">
      ...
      <div className="container relative mx-auto px-4 py-block">
        <div className="md:w-2/3 text-center mx-auto mb-12">
          <div className="text-sm uppercase font-semibold tracking-widest text-primary mb-2">
            Services
          </div>
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Your success, our <span className="italic">commitment</span>.
          </h2>
          <p className="text-subtle max-w-[80ch] mx-auto">
        ...
        <div className="my-8 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {servicesProvided.map((service, i) => {
            ...
            return (
              ...
              >
                <div className="card bg-base-300 shadow-md hover:shadow-accent/30 card-border border-base-300 hover:border-accent/30 transition duration-250 p-6 flex items-center justify-center h-full gap-x-4">
                  ...
                  <p className="text-subtle max-w-[40ch]">
                    {service.description}
                  </p>
                </div>
